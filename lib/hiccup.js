...
(function(exports) {
    ...
    exports.textArea = defElem(function(name, value) {
        return ["textarea", {name: name, id: name}, value];
    });
    ...
    // A function wrapper that returns a tag array. If the second argument is
    // an object, the wrapped function is called without it and the object is
    // merged into the attribute map of the resulting tag array.
    function defElem(fn) {
        return function() {
